...
def main(): 
    ...
    left_robot_pose = np.array([0, 0.8, 0, 1, 0, 0, 0])
    right_robot_pose = np.array([0, -0.4, 0, 1, 0, 0, 0])
    # joint_names = ['joint1', 'joint2', 'joint3', 'joint4', 'joint5', 'joint6', 'gripper_finger1_inner_knuckle_joint','gripper_finger1_finger_tip_joint' ,
    #                'gripper_finger1_joint','gripper_finger1_finger_joint','gripper_finger2_inner_knuckle_joint','gripper_finger2_finger_tip_joint','gripper_finger2_joint' ,
    #                'gripper_finger2_finger_joint']

    joint_names = ['joint1', 'joint2', 'joint3', 'joint4', 'joint5', 'joint6', 'thumb_q1', 'index_q1',
                   'middle_q1', 'ring_q1', 'pinky_q1', 'thumb_q2', 'index_q2', 'middle_q2', 'ring_q2', 'pinky_q2']


    # joint_names = ['joint1', 'joint2', 'joint3', 'joint4', 'joint5', 'joint6', "thumb_tip",  "index_tip" ]
