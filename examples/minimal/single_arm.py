...
from bunny_teleop.Elfin_teleop_client import TeleopClient
from bunny_teleop.Elfin_init_config import BimanualAlignmentMode
...
def main():
    ...
    teleop_client.send_init_config(
        robot_base_pose=(left_robot_pose, ),
        init_qpos=(init_qpos, ),
